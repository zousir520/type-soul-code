<script lang="ts">
	...
	let currentSiteType: SiteType = $state('site-game'); // 强制设置为 game 模式
</script>

<SEO 
	title="Game Mode Preview - tenniszero.org"
	description="Preview of Game mode homepage"
	robots="noindex, nofollow"
/>

<!-- 预览模式提示条 -->
<div class="bg-purple-600 theme-text-primary text-center py-2 px-4 text-sm font-medium">
	🎮 预览模式：Game 模式 - 此页面不会被搜索引擎索引
