<script lang="ts">
	...
	let currentSiteType: SiteType = $state('site-tool'); // 强制设置为 tool 模式
</script>

<SEO 
	title="Tool Mode Preview - tenniszero.org"
	description="Preview of Tool mode homepage"
	robots="noindex, nofollow"
/>

<!-- 预览模式提示条 -->
<div class="bg-blue-600 theme-text-primary text-center py-2 px-4 text-sm font-medium">
	🔍 预览模式：Tool 模式 - 此页面不会被搜索引擎索引
