        ...
        <div class="mt-6">
          <div class="inline-flex rounded-lg border border-border bg-card p-1">
            ...
            {#each otherLanguages.slice(0, 3) as lang}
              <a
                href={lang.code === 'en' ? '/docs' : `/docs/${lang.code}`}
